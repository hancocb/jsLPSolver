          ...
          for (var i = 0; i < input.length; i++) {
            ...
            if (rxo.is_objective.test(tmp)) {
              ...
              var constraintExpression =
                separatorIndex === -1 ? tmp : tmp.slice(separatorIndex + 1);
        ...
        function from_JSON(model) {
          ...
          if (model.opType) {
            ...
            for (var x in model.variables) {
              ...
              // it exists already
              model.variables[x][x] = model.variables[x][x]
                ? model.variables[x][x]
                : 1;
              ...
              if (model.variables[x][model.optimize]) {
                output +=
                  ' ' +
                  model.variables[x][model.optimize] +
                  ' ' +
                  x.replace(rxClean, '_');
              }
            }
...
*/
    ...
    5: [
      function (require, module, exports) {
        ...
        Model.prototype.equal = function (rhs) {
          var constraintUpper = new Constraint(
            rhs,
            true,
            this.tableau.getNewElementIndex(),
            this
          ...
          var constraintLower = new Constraint(
            rhs,
            false,
            this.tableau.getNewElementIndex(),
            this
        ...
        Model.prototype.updateRightHandSide = function (
          constraint,
          difference
        ) {
          if (this.tableauInitialized === true) {
        ...
        Solution.prototype.generateSolutionSet = function () {
          ...
          for (var r = 1; r <= lastRow; r += 1) {
            ...
            solutionSet[variable.id] =
              Math.round((Number.EPSILON + varValue) * roundingCoeff) /
              roundingCoeff;
          }
    ...
    9: [
      function (require, module, exports) {
        ...
        OptionalObjective.prototype.copy = function () {
          var copy = new OptionalObjective(
            this.priority,
        ...
        Tableau.prototype.setOptionalObjective = function (
          priority,
          column,
          cost
        ) {
        ...
        Tableau.prototype.setEvaluation = function () {
          ...
          var roundedEvaluation =
            Math.round((Number.EPSILON + evaluation) * roundingCoeff) /
            roundingCoeff;
        ...
        Tableau.prototype.getSolution = function () {
          var evaluation =
            this.model.isMinimization === true
              ? this.evaluation
              : -this.evaluation;
    ...
    11: [
      function (require, module, exports) {
        ...
        Tableau.prototype.branchAndCut = function () {
          ...
          for (
            var oInit = 0;
            oInit < this.optionalObjectives.length;
            oInit += 1
          ) {
          ...
          while (
            ...
            if (this.isIntegral() === true) {
              ...
              for (
                ...
                bestOptionalObjectivesEvaluations[
                  oCopy
      ...
      function (require, module, exports) {
        ...
        Tableau.prototype.addCutConstraints = function (cutConstraints) {
          ...
          for (var i = 0; i < nCutConstraints; i += 1) {
            ...
            this.variablesPerIndex[slackVarIndex] = new SlackVariable(
              's' + slackVarIndex,
              slackVarIndex
            );
            this.nVars += 1;
    ...
    14: [
      function (require, module, exports) {
        ...
        Tableau.prototype._putInBase = function (varIndex) {
          ...
          if (r === -1) {
            ...
            for (var r1 = 1; r1 < this.height; r1 += 1) {
              ...
              if (
                coefficient < -this.precision ||
                this.precision < coefficient
              ) {
                r = r1;
                break;
              }
        ...
        Tableau.prototype.updateVariableValues = function () {
          ...
          for (var v = 0; v < nVars; v += 1) {
            ...
            if (r === -1) {
              ...
              variable.value =
                Math.round((varValue + Number.EPSILON) * roundingCoeff) /
                roundingCoeff;
            }
          }
        };

        Tableau.prototype.updateRightHandSide = function (
          constraint,
          difference
        ) {
        ...
        Tableau.prototype.addVariable = function (variable) {
          ...
          var cost =
            this.model.isMinimization === true ? -variable.cost : variable.cost;
          var priority = variable.priority;
    ...
    16: [
      function (require, module, exports) {
        ...
        Tableau.prototype.computeFractionalVolume = function (
          ignoreIntegerValues
        ) {
          var volume = -1;
          // var integerVariables = this.model.integerVariables;
        ...
        Tableau.prototype.phase1 = function () {
          ...
          while (true) {
            ...
            for (var r = 1; r <= lastRow; r++) {
              unrestricted =
                this.unrestrictedVars[this.varIndexByRow[r]] === true;
            ...
            for (var c = 1; c <= lastColumn; c++) {
              ...
              unrestricted =
                this.unrestrictedVars[this.varIndexByCol[c]] === true;
        ...
        Tableau.prototype.phase2 = function () {
          ...
          while (true) {
            ...
            for (var r = 1; r <= lastRow; r++) {
              ...
              var quotient = isReducedCostNegative
                ? -rhsValue / colValue
                : rhsValue / colValue;
        ...
        Tableau.prototype.pivot = function (pivotRowIndex, pivotColumnIndex) {
          ...
          for (var r = 0; r <= lastRow; r++) {
            if (r !== pivotRowIndex) {
              ...
              if (
                !(
                  matrix[r][pivotColumnIndex] >= -1e-16 &&
                  matrix[r][pivotColumnIndex] <= 1e-16
                )
              ) {
    ...
    20: [
      function (require, module, exports) {
        ...
        Constraint.prototype.setVariableCoefficient = function (
          ...
          if (term === undefined) {
            ...
            if (newCoefficient !== term.coefficient) {
              ...
              this.model.updateConstraintCoefficient(
                this,
                variable,
                difference
              );
        ...
        Constraint.prototype.relax = function (weight, priority) {
          this.relaxation = createRelaxationVariable(
            this.model,
            weight,
            priority
          );
